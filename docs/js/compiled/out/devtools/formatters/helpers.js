...
var G__51958 = devtools.prefs.pref.call(null,v);
v = G__51958;
continue;
} else {
return v;
...
var and__41355__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__41355__auto__){
var and__41355__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__41367__auto__ = (function (){try{if(!((value == null))){
...
}catch (e51961){var _e__50806__auto__ = e51961;
return false;
}})();
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
var or__41367__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e51968){var _e__50806__auto__ = e51968;
return false;
}})();
...
}catch (e51970){var _e__50806__auto__ = e51970;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__41355__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41355__auto__)){
var and__41355__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__41355__auto____$1){
...
var and__41355__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__41355__auto__)){
...
var or__41367__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
...
var and__41355__auto__ = (function (){var or__41367__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
...
var vec__51978 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__51978,(0),null);
var name = cljs.core.nth.call(null,vec__51978,(1),null);
...
var and__41355__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__41355__auto__)){
...
var or__41367__auto__ = typeof value === 'string';
if(or__41367__auto__){
return or__41367__auto__;
} else {
var or__41367__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__51984_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__51984_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1538003630354
