...
var len__42646__auto___52069 = arguments.length;
var i__42647__auto___52070 = (0);
while(true){
if((i__42647__auto___52070 < len__42646__auto___52069)){
args__42653__auto__.push((arguments[i__42647__auto___52070]));

var G__52071 = (i__42647__auto___52070 + (1));
i__42647__auto___52070 = G__52071;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__42654__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq52059){
var G__52060 = cljs.core.first.call(null,seq52059);
var seq52059__$1 = cljs.core.next.call(null,seq52059);
var G__52061 = cljs.core.first.call(null,seq52059__$1);
var seq52059__$2 = cljs.core.next.call(null,seq52059__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__52060,G__52061,seq52059__$2);
});
...
if(cljs.core.truth_((function (){var or__41367__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__42038__auto__,writer__42039__auto__,opt__42040__auto__){
return cljs.core._write.call(null,writer__42039__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__41355__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__41355__auto__){
var or__41367__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__52104_SHARP_){
return !((cljs.core.meta.call(null,p1__52104_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__52118__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__41367__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e52122){var _e__50806__auto__ = e52122;
return false;
}})();
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
...
}catch (e52124){var _e__50806__auto__ = e52124;
return false;
}}
})())){
...
var _STAR_current_state_STAR_52147 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__52148 = opts;
var map__52148__$1 = ((((!((map__52148 == null)))?((((map__52148.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52148.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52148):map__52148);
var markup_db = cljs.core.get.call(null,map__52148__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_52147;
}});
...
;
var temp__5455__auto___52155 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___52155)){
var managed_print_level_52156 = temp__5455__auto___52155;
var _STAR_print_level_STAR_52154_52157 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_52156;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_52154_52157,managed_print_level_52156,temp__5455__auto___52155,writer,opts,job_fn){
return (function (p1__52150_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__52150_SHARP_,null);
});})(_STAR_print_level_STAR_52154_52157,managed_print_level_52156,temp__5455__auto___52155,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_52154_52157;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1538003630526
