...
var len__42646__auto___50535 = arguments.length;
var i__42647__auto___50536 = (0);
while(true){
if((i__42647__auto___50536 < len__42646__auto___50535)){
args__42653__auto__.push((arguments[i__42647__auto___50536]));

var G__50538 = (i__42647__auto___50536 + (1));
i__42647__auto___50536 = G__50538;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42654__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq50527){
var G__50529 = cljs.core.first.call(null,seq50527);
var seq50527__$1 = cljs.core.next.call(null,seq50527);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__50529,seq50527__$1);
});
...
return (p1__50560_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1538003629339
