...
var reader = (function (){var or__41367__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__41367__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__52526__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__52526__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__52526__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e52525){var _e = e52525;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___52528 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___52528)){
var seen_errors_52532 = temp__5455__auto___52528;
if(cljs.core.truth_(seen_errors_52532.has(self))){
} else {
seen_errors_52532.add(self);

var temp__5457__auto___52533 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___52533)){
var sense_52534 = temp__5457__auto___52533;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_52534)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1538003630781
