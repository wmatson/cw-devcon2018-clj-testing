...
var o51028 = temp__5455__auto__;
var temp__5455__auto____$1 = (o51028["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o51029 = temp__5455__auto____$1;
return (o51029["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__50795__auto__ = f;
return (o__50795__auto__["toString"]).call(o__50795__auto__);
} else {
return "";
}
}catch (e51036){var _ = e51036;
return "";
}});
...
try{var o__50795__auto___51066 = t;
(o__50795__auto___51066["cljs$lang$ctorPrWriter"]).call(o__50795__auto___51066,t,writer);
}catch (e51060){var __51067 = e51060;
}
...
var char_code = (function (){var o__50795__auto__ = (new String(char$));
return (o__50795__auto__["charCodeAt"]).call(o__50795__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__50795__auto__ = String;
return (o__50795__auto__["fromCharCode"]).call(o__50795__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__51085 = num_code;
switch (G__51085) {
case (1):
return (185);
...
var o__50795__auto__ = String;
return (o__50795__auto__["fromCharCode"]).call(o__50795__auto__,superscript_code);
});
/**
...
}catch (e51124){var _e__50806__auto__ = e51124;
return false;
}})())){
...
var vec__51125 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__51125,(0),null);
...
var or__41367__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o51158 = temp__5455__auto__;
var temp__5455__auto____$1 = (o51158["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o51159 = temp__5455__auto____$1;
return (o51159["nameToPath"]);
} else {
return null;
}
} else {
...
var len__42646__auto___51175 = arguments.length;
var i__42647__auto___51177 = (0);
while(true){
if((i__42647__auto___51177 < len__42646__auto___51175)){
args__42653__auto__.push((arguments[i__42647__auto___51177]));

var G__51180 = (i__42647__auto___51177 + (1));
i__42647__auto___51177 = G__51180;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42654__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__51168){
var vec__51169 = p__51168;
var ns_detector = cljs.core.nth.call(null,vec__51169,(0),null);
var effective_detector = (function (){var or__41367__auto__ = ns_detector;
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
...
var G__51189 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__51190 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__51189;
remaining_tokens = G__51190;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq51164){
var G__51165 = cljs.core.first.call(null,seq51164);
var seq51164__$1 = cljs.core.next.call(null,seq51164);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__51165,seq51164__$1);
});
...
var vec__51202 = cljs.core.split_with.call(null,(function (p1__51200_SHARP_){
return cljs.core.not_EQ_.call(null,p1__51200_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__51202,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__51202,(1),null);
...
var vec__51210 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__51210,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__51210,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__51218 = cljs.core.rest.call(null,remaining_tokens);
var G__51219 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__51218;
name_tokens = G__51219;
continue;
} else {
...
var vec__51226 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__51226,(0),null);
var arity = cljs.core.nth.call(null,vec__51226,(1),null);
var vec__51229 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__51229,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__51229,(1),null);
var vec__51232 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__51232,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__51232,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__51232,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__51232,(3),null);
...
var vec__51260 = result;
var munged_ns = cljs.core.nth.call(null,vec__51260,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__51260,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__51260,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__51260,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__51260,(4),null);
var arity = cljs.core.nth.call(null,vec__51260,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__51276 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__51276,(0),null);
var args = cljs.core.nth.call(null,vec__51276,(1),null);
var vec__51279 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__51279,(0),null);
var name = cljs.core.nth.call(null,vec__51279,(1),null);
...
var G__51308 = (arity + (1));
var G__51309 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__51317){
var vec__51318 = p__51317;
var arity = cljs.core.nth.call(null,vec__51318,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__51318,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__41367__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
...
return (function (p1__51344_SHARP_){
return cljs.core.get.call(null,arities,p1__51344_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__51345_SHARP_);
...
var args__42653__auto__ = [];
var len__42646__auto___51360 = arguments.length;
var i__42647__auto___51361 = (0);
while(true){
if((i__42647__auto___51361 < len__42646__auto___51360)){
args__42653__auto__.push((arguments[i__42647__auto___51361]));

var G__51362 = (i__42647__auto___51361 + (1));
i__42647__auto___51361 = G__51362;
continue;
} else {
}
break;
...
var argseq__42654__auto__ = ((((1) < args__42653__auto__.length))?(new cljs.core.IndexedSeq(args__42653__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42654__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__51354){
var vec__51355 = p__51354;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__51355,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq51352){
var G__51353 = cljs.core.first.call(null,seq51352);
var seq51352__$1 = cljs.core.next.call(null,seq51352);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__51353,seq51352__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__41367__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__41355__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__41367__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__51399__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__51399__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__51399__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__51399__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__51400 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__51400,(0),null);
var fn_name = cljs.core.nth.call(null,vec__51400,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__51400,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__51400,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__51400,(4),null);
var arity = cljs.core.nth.call(null,vec__51400,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__41355__auto__ = protocol_ns;
if(cljs.core.truth_(and__41355__auto__)){
return cljs.core.not.call(null,(function (){var and__41355__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__41367__auto__ = protocol_part;
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
return fn_part;
...
var o__50795__auto__ = f;
return (o__50795__auto__["getBasis"]).call(o__50795__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__41355__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41355__auto__)){
...
}catch (e51424){var _e__50806__auto__ = e51424;
...
var G__51433 = (obj[cljs.core.first.call(null,path)]);
var G__51434 = cljs.core.rest.call(null,path);
obj = G__51433;
path = G__51434;
continue;
} else {
...
var partition_bits = (function (){var or__41367__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__41367__auto__)){
return or__41367__auto__;
} else {
return (0);
...
return (function (accum,p__51477){
var vec__51478 = p__51477;
var bit = cljs.core.nth.call(null,vec__51478,(0),null);
var protocol = cljs.core.nth.call(null,vec__51478,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__51490){
var vec__51491 = p__51490;
var ns = cljs.core.nth.call(null,vec__51491,(0),null);
var name = cljs.core.nth.call(null,vec__51491,(1),null);
var selector = cljs.core.nth.call(null,vec__51491,(2),null);
...
return (function (p__51496){
var vec__51497 = p__51496;
var munged_name = cljs.core.nth.call(null,vec__51497,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__51497,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__51497,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__51495_SHARP_){
return (obj[cljs.core.first.call(null,p1__51495_SHARP_)]);
});})(name,sorted_matches,vec__51497,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1538003629785
