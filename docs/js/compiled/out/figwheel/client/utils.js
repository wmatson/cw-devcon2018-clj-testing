...
var or__41367__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj49036 = {"detail":data};
return obj49036;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__41355__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__41355__auto__)){
var and__41355__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__49043 = cljs.core._EQ_;
var expr__49044 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__49043.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__49044))){
return ((function (pred__49043,expr__49044){
return (function (p1__49037_SHARP_){
return console.warn(p1__49037_SHARP_);
});
;})(pred__49043,expr__49044))
} else {
if(cljs.core.truth_(pred__49043.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__49044))){
return ((function (pred__49043,expr__49044){
return (function (p1__49038_SHARP_){
return console.debug(p1__49038_SHARP_);
});
;})(pred__49043,expr__49044))
} else {
if(cljs.core.truth_(pred__49043.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__49044))){
return ((function (pred__49043,expr__49044){
return (function (p1__49039_SHARP_){
return console.error(p1__49039_SHARP_);
});
;})(pred__49043,expr__49044))
} else {
return ((function (pred__49043,expr__49044){
return (function (p1__49040_SHARP_){
return console.log(p1__49040_SHARP_);
});
;})(pred__49043,expr__49044))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__49047){
var map__49048 = p__49047;
var map__49048__$1 = ((((!((map__49048 == null)))?((((map__49048.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49048.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49048):map__49048);
var opts = map__49048__$1;
var eval_fn = cljs.core.get.call(null,map__49048__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__49050_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__49052,(0),null);
var v = cljs.core.nth.call(null,vec__49052,(1),null);
...
if(cljs.core.truth_((function (){var and__41355__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1538003627797
